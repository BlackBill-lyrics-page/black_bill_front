...
export default function UpcomingStageCard({
  ...
  return (
    <button
      onClick={onClick}
      className="rounded-xl overflow-hidden bg-white hover:shadow-md transition text-left"
    ...
    >
      ...
      <div className="relative aspect-square rounded-xl bg-gray-100 overflow-hidden">
        ...
        {/* [NEW] 날짜+시간 배지 (좌상단) */}
        <span className="absolute left-1/2 -translate-x-1/2 whitespace-nowrap top-1 rounded px-1.5 py-0.5 text-[10px] leading-none bg-black/70 text-white">
          {dateTime}
        </span>
      </div>
